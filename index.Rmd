---
title: "Hacia una Escala de la Precariedad Laboral en Trabajadores Independientes"
description: |
 Texto elaborado en el marco del [Diplomado de Postítulo Análisis Multivariable](http://www.facso.uchile.cl/postgrado/123608/diplomado-de-postitulo-analisis-multivariable) de la Universidad de Chile. Actualmente está en desarrollo y mejora para publicarse como capítulo de libro.  |
...
author:
  - name: Fernando Baeza
    ...
    affiliation_url: http://www.doctorado.geografia.uc.cl/
    orcid_id:
  - name: Nicolás Ratto
    url: https://nicolasrattor.netlify.app/
    affiliation: Universidad de Chile
    affiliation_url: http://www.facso.uchile.cl/
...
El estudio conjunto de la precariedad laboral y el trabajo independiente o por cuenta propia, sin embargo, es escaso. Lo que suele observarse cuando se analiza la precariedad, es la realidad de los asalariados y en particular el debilitamiento de la relación salarial (Ruiz-Tagle & Sehnbruch, 2015; Vives et al., 2017), siguiendo las líneas de investigación de los países donde la asalarización se encuentra mucho más extendida que en América Latina. Por otra parte, frecuentemente se ha asimilado la realidad de los trabajadores independientes al sector informal (Temkin, 2009), categoría esta última que si bien puede clasificar a buena parte de los independientes, es insuficiente porque no incluye a todos, y sobre todo porque no representa aquello que constituiría la precariedad específica de estos trabajadores (Jiménez, 2013; Wall, 2015). 

Dada la extensión del trabajo independiente en Chile y América Latina, y las múltiples formas que este ha adquirido en la actualidad a nivel global (Bögenhold, 2019; De Moortel & Vanroelen, 2017), es claro que un análisis específico de la precariedad laboral en este segmento del mercado laboral se hace necesario. Sin embargo, actualmente no se cuenta con instrumentos ni datos apropiados para la medición, habida cuenta de que los marcos conceptuales desarrollados para el estudio de la precariedad en los asalariados son teórica y operacionalmente inadecuados para el análisis de los independientes. En efecto, los estudios realizados tanto en Chile (Gálvez, 2001, 2003; Jiménez, 2013) como en Europa y Norteamérica (Glavin et al., 2019; Kovesi & Kern, 2018; Oostveen et al., 2013; Pedersini & Coletto, 2009; Vosko, 2009) muestran que la precariedad es un problema relevante en el mundo de los trabajadores independientes, pero que tiene particularidades que obligan a conceptualizar y medir el fenómeno de una forma específica: por un lado, no hay empleadores, ni amenazas de despido; pero por otro, hay clientes demandantes, la amenaza de la quiebra y, en general, una ausencia de seguridad social como la que suele implicar el empleo asalariado formal. En ausencia de una comprensión específica de la precariedad en los trabajadores informales, las políticas públicas diseñadas para enfrentar la precariedad no serían efectivas al no identificar adecuadamente el problema, su magnitud y sus causas (Temkin, 2009; Wall, 2015).

Este artículo, presenta una propuesta para la medición de la precariedad laboral en los trabajadores independientes que considere la especificidad de esta categoría ocupacional, a partir de la adaptación de la Escala de Precariedad Laboral aplicada en su versión chilena (EPRES-Ch) en la Encuesta Nacional de Condiciones de Empleo, Trabajo y Salud (ENETS) de los años 2009-2010, utilizando para la evaluación de la escala propuesta la técnica de análisis factorial confirmatorio de ítems o AFI (Wirth & Edwards, 2007). Complementando esta Introducción, se presentan los antecedentes conceptuales sobre el trabajo independiente, la precariedad laboral y una propuesta para su medición, basada en la EPRES-Ch. 
...
En cuanto dimensión psicosocial, la precariedad se sitúa en el espacio intersubjetivo de la vida cotidiana en el trabajo y en las relaciones sociales que en ese espacio se generan (Amable, 2004; Dejours, 2006), y entre otras cosas, “bloquea” los efectos positivos, manifiestos y latentes, del empleo y, genera efectos dañinos sobre la salud (Benach et al., 2014; Neffa, 2015). Precisamente con relación a la salud y la calidad de vida de los trabajadores es que el estudio de la precariedad ha mostrado alguno de sus progresos más importantes, demostrándose con claridad hasta qué punto la situación de precariedad resulta nociva para la salud física y mental de la población, encontrándose evidencia contundente al respecto en desenlaces tan variados como depresión, enfermedades cardiovasculares, dolores musculoesqueléticos, entre otros (Benach et al., 2014; Vives et al., 2019). 
...
Como ya se ha señalado, analíticamente los trabajadores independientes presentan al mismo tiempo características de los asalariados y de los empleadores (de sí mismos) (Wright, 1994). Compartirían con los asalariados, entonces, las fuentes de la precariedad capturadas en las cuatro dimensiones comunes de la EPRES, que son las que no implican necesariamente una relación salarial: temporalidad, ingresos, derechos y ejercicio de derechos. Pero, por otra parte, los trabajadores por cuenta propia se ven expuestos en su calidad de poseedores de los medios de producción a otras fuentes de la precariedad que, grosso modo, pueden distinguirse en dos grupos: la eventual falta de independencia para controlar el proceso productivo, que es controlado por otro o por el ritmo del negocio, y la carencia de protección frente a los riesgos que por definición los dueños del capital asumen.

Respecto a la falta de independencia por el control exógeno del proceso productivo, Gálvez (2001) propone el concepto de “dependiente periférico” para identificar a los trabajadores que son jurídicamente independientes (esto es, de forma residual, no contratados como asalariados), pero en los hechos están sometidos a relaciones de dependencia más o menos evidentes respecto a otra entidad, y no concurren libremente al mercado de bienes/servicios que producen, sino que lo hacen a través de un tercero que compra toda o gran parte de la producción y/o que puede normar las formas de producción (jornada, precios, procesos, etc.). En Europa, estos trabajadores “económicamente dependientes” muestran peores condiciones de acceso a la seguridad social, menores ingresos y mayor inseguridad laboral que los empleadores y otros trabajadores por cuenta propia (Oostveen et al., 2013). El carácter de precariedad estaría dado por lo observado en estudios cualitativos respecto a que estos trabajadores reconocen en la independencia y autonomía la cara positiva del trabajo por cuenta propia (Benz & Frey, 2008), y en el control externo, lo opuesto (Jiménez, 2013), asociando la falta de independencia a insatisfacción con el trabajo (Böheim & Mühlberger, 2009). 

Pero la falta de independencia en el control del proceso productivo también puede venir, endógenamente, del propio proceso productivo. En efecto, los ritmos de la producción y comercialización de bienes y servicios pueden impedir una reproducción saludable de los ritmos biológicos y sociales del trabajador, obligándolo a intensidades de trabajo indeseables o incompatibles con la vida familiar cuyos efectos sobre la salud ya han sido demostrados entre los trabajadores asalariados (Artazcoz et al., 2007; Mcnamara et al., 2011). En el caso de los independientes, al ser el propio trabajador el responsable del éxito de la empresa y quien carga el riesgo económico, todos los aspectos del proceso productivo y comercial -búsqueda de clientes, relaciones con proveedores, además de la misma producción del bien o servicio, etcétera- quedan a cargo de un solo individuo, lo que fácilmente puede traducirse en una incapacidad de regular las horas de trabajo, separándolas del tiempo de descanso, especialmente en períodos de alta demanda. En efecto, entre los trabajadores por cuenta propia se han observado mayores dificultades para conciliar la vida familiar con el trabajo, mayores dificultades en el sueño y en algunos casos, menores niveles de satisfacción con la vida en general (Binder & Coad, 2013; Blanchflower, 2004; Parasuraman & Simmers, 2001). El rasgo más saliente de esta falta de control sobre el proceso productivo sería la excesiva extensión de la jornada de trabajo, lo que Blanco y Julián (2019) han denominado “cronopiedad”, y que se expresaría tanto en una alta cantidad de horas de trabajo realizadas semanalmente, así como también el trabajo en días generalmente destinados al descanso, como los sábados y domingos.

El riesgo económico, por su parte, es un elemento constitutivo de la independencia, tal como se señala en la definición estadística de la CISE-93. Administrar el riesgo implica tomar todas las acciones necesarias para salvaguardar los bienes de la empresa ante posibles pérdidas derivadas de la actividad (Verbano & Venturini, 2013), y en este sentido, no es el riesgo lo que definiría la situación de precariedad, sino la falta de protección frente al mismo. También en este caso hay dos dimensiones: la ausencia de protección frente al riesgo de carácter dinámico, referido a la posibilidad de obtener pérdidas económicas como consecuencia de la incertidumbre asociada a la adopción de ciertas acciones, y la ausencia de protección frente al riesgo de carácter estático, referido al riesgo indeterminado, sin posibilidad de obtener ganancia, asociado a los accidentes que afectan los recursos de la empresa. Ambas fuentes de riesgo suponen que el trabajador debería adoptar medidas de protección, tendientes tanto a separar los efectos negativos que el riesgo dinámico puede suponer para la reproducción del trabajador por la variabilidad de las ventas o la quiebra de la empresa, como a asegurar al negocio frente a las eventualidades del riesgo estático.
...
+ La ausencia de protección frente al riesgo de carácter dinámico traería como consecuencia la vulnerabilidad de los ingresos del trabajador y su hogar, como consecuencia del flujo variable de ingresos y la no separación de los ingresos de la empresa y del trabajador, por ejemplo, mediante la formalización del negocio.

+ La ausencia de protección frente al riesgo de carácter estático se puede observar a través del aseguramiento económico frente a accidentes u otras eventualidades que afecten al capital invertido por la empresa (instalaciones, maquinaria, herramientas, insumos, etc.).
...
La Encuesta Nacional de Condiciones de Empleo, Trabajo y Salud fue realizada por el Ministerio de Salud de Chile, y corresponde a una encuesta transversal representativa a nivel nacional, de los sectores urbano y rural, de cada una de las 15 regiones existentes al año 2009 y, de la población de 15 años o más que tuvo algún trabajo remunerado durante los 12 meses anteriores al empadronamiento. En base a un muestreo probabilístico múltietapico, el trabajo de campo se realizó entre los meses de septiembre de 2009 y octubre de 2010, obteniendo una tasa de respuesta del 73,9% (Solar et al., 2010).

La base de la ENETS 2009-2010 está compuesta por 9.503 casos, los que representan a casi 7,4 millones de trabajadores y trabajadoras.  De entre los trabajadores ocupados (8.356) se seleccionaron a los que calificaron como trabajadores independientes, es decir, los trabajadores por cuenta propia o empleadores de hasta 5 trabajadores no permanentes , los cuales sólo pueden corresponder a familiares, trabajadores no remunerados o socios. Con esta selección se obtuvo un total de 2.115 casos (que corresponden a un universo estimado de 1,54 millones de trabajadores): 1.639 trabajadores por cuenta propia sin empleados y 476 empleadores. 

Para el análisis, se utilizaron 22 variables agrupadas en 6 dimensiones: 15 ítems correspondientes a las cuatro dimensiones comunes de la precariedad entre asalariados e independientes medidas en la EPRES-Ch, y 7 ítems de las dos dimensiones propuestas para la medición del control exógeno y endógeno del proceso productivo, únicas dimensiones para las cuales se identificaron preguntas pertinentes en la ENETS. Las variables incluidas en el modelo inicial y su correspondencia con las dimensiones teóricas se presentan en la Tabla 2.

En un primer momento se realizó un análisis descriptivo de las variables incluidas en el modelo, y posteriormente, para determinar el ajuste del modelo de factores propuesto en la Tabla 2, se realizó un análisis factorial confirmatorio en su modalidad análisis factorial de ítems (AFI), basado en correlaciones tetracóricas y policóricas, que ha demostrado ser capaz de “evidenciar la verdadera estructura multidimensional de una variable latente”, incluso en presencia de variables con alta asimetría (Rdz-Navarro & Asún, 2016, p. 5). Para esto se utilizó el WLSMV (weighted least square mean and variance) como estimador de las correlaciones, apropiado para datos categóricos y muestras relativamente grandes (n ≥ 1000) (Lloret-Segura et al., 2014). Para evaluar la fiabilidad de la escala y sus dimensiones, su consistencia interna fue calculada utilizando el alpha para datos categóricos ordenados, estimado según las fórmulas propuestas por Elosua y Zumbo (2008, p. 899), calculando la comunalidad y unicidad a partir de los lambdas obtenidos en el modelo para cada ítem, y el alfa de Cronbach para el caso de las variables continuas. Para la preparación de los datos y el análisis descriptivo se utilizó el software R 3.6.3 (R Core Team, 2020), y para el análisis factorial Mplus 7.4 (Muthén & Muthén, 2015). 
...
La Tabla 1 presenta algunas características demográficas y ocupacionales de la muestra de trabajadores independientes. Como se observa, la mayor parte de los trabajadores independientes son hombres, casi la mitad tiene entre 45 y 64 años y sólo un 15,7% alcanzó la educación superior (técnica o universitaria). En comparación con el resto de los ocupados, la proporción de hombres entre los trabajadores independientes es levemente superior (64,0% vs. 61,2%), y presentan una media de edad más elevada (49,1 [12,6] vs. 41,1 [12,5]).   Por otra parte, los trabajadores no independientes suelen tener mayor escolaridad: un 27,8% de ellos ha alcanzado la educación superior.  

Los trabajadores independientes suelen ocuparse como trabajadores de servicios y vendedores de comercio (29,1%), oficiales, operarios y artesanos de artes mecánicas y de otros oficios (24,6%), trabajadores no calificados (15,4%), así también como agricultores y trabajadores calificados agropecuarios y pesqueros (12,3%). Los independientes realizan actividades económicas principalmente en los sectores del comercio, restaurantes y hoteles (38,6%), seguidos de los servicios comunales y sociales (17,9%), la agricultura (13,2%) y la construcción (12,1%). Proporcionalmente, los trabajadores independientes se concentran en todas estas ocupaciones y sectores económicos en mayor medida que el resto de los ocupados, excepto por los trabajos no calificados y los servicios comunales y sociales. Destaca particularmente la concentración de los independientes en el sector comercio, que duplica a la observada en el resto de los ocupados (19,0%),  así como también las ocupaciones como operarios  (12,7% entre los no independientes).

La escala de precariedad laboral para trabajadores independientes explorada, incluye las cuatro dimensiones comunes de la EPRES  cuyos ítems aplicaban también para los independientes: temporalidad, ingresos, derechos y ejercicio de derechos (Vives et al., 2017). Las dimensiones de vulnerabilidad y empoderamiento, en cambio, no fueron incluidas ya que su naturaleza supone una relación con un empleador o jefe con quien se negocian las condiciones de trabajo. Por la misma razón, en la dimensión temporalidad, también se excluyó la pregunta por la duración del contrato de trabajo que originalmente forma parte de la EPRES, y se agregaron en cambio dos preguntas: una -T2- sobre la percepción de estabilidad en el empleo (“En su actual trabajo, Ud. siente su relación de empleo como”), y otra -T3- sobre el carácter temporal o permanente del trabajo (“Su trabajo es de tipo”). En la dimensión derechos, se excluyó también la pregunta sobre el seguro contra accidentes y enfermedades del trabajo, ya que dicho seguro no aplica para los empleadores que fueron clasificados como trabajadores independientes. Cabe destacar que la legislación (Ley 16.744) establece que los trabajadores independientes pueden acceder al Seguro Social contra Riesgos de Accidentes del Trabajo y Enfermedades Profesionales cotizando voluntariamente, para lo cual deben acreditar su condición de también cotizantes en sistemas de ahorro previsional (AFP) y de salud (FONASA o ISAPRE), quedando así el acceso al seguro contra accidentes y enfermedades condicionado a la cotización en los otros sistemas de seguridad. Por lo mismo, se incluyó un tercer ítem en esta dimensión que refiere precisamente a la afiliación y cotización en algún sistema de salud (“¿A qué sistema previsional de salud pertenece Ud., ya sea como cotizante o carga?”). 

Respecto a las dimensiones específicas de la precariedad laboral en los trabajadores independientes, en la ENETS no se incluyeron preguntas que permitieran medir la protección frente a los riesgos estáticos o dinámicos, por lo que estas dimensiones no fueron incluidas en esta propuesta. Un mejor instrumento para medir estas dimensiones específicas puede ser la Encuesta de Microemprendimiento, cuyo marco muestral es similar a lo que acá se ha entendido como trabajadores independientes, e incluye preguntas que permiten evaluar la formalización del negocio, la separación de los ingresos, el aseguramiento del capital frente a pérdidas, asignación de un sueldo para el emprendedor, entre otras. 

Respecto a la dimensión de control exógeno se incluyeron variables que permiten identificar a quienes son, en realidad, dependientes periféricos, a partir de las relaciones que estos trabajadores establecen con clientes y proveedores, siguiendo las recomendaciones de Gálvez (2001). En particular, se evalúa el número de clientes y proveedores que cada independiente tiene (CEX1, CEX2), siendo más precaria la situación de quienes tienen sólo un cliente o proveedor. La dependencia más o menos exclusiva de clientes o proveedores sería indicativo de una situación estructural que podría derivar en la pérdida de control sobre el proceso productivo, lo que también se manifestaría en un acuerdo por la exclusividad de la relación (CEX4) y en la capacidad del cliente/proveedor de normar la organización del proceso de trabajo (CEX4 ).

En cuanto a la pérdida endógena de control del proceso de trabajo, se han incluido variables que permiten identificar como precarios aquellos casos en que los trabajadores independientes presentan jornadas de trabajo excesivas, teniendo como referencia la jornada laboral de 45 horas semanales estipulada para los trabajadores dependientes por el Código del Trabajo. En la muestra, el 40,4% de los trabajadores independientes trabajan de lunes a domingo, y otro 38,7% lo hace de lunes a viernes y algún día del fin de semana. De quienes trabajan más de 5 días, la mayoría trabaja en total más de 45 horas semanales. Como casi no hay casos de personas que trabajen sólo en fines de semana (0,9%), se define que quienes trabajan más de 9 horas diarias de lunes a viernes trabajan una cantidad de horas excesiva, así como también quienes trabajan, las horas que sean, en sábado o domingo, ya que prácticamente nadie no trabaja   de lunes a viernes, por lo que el trabajo en fin de semana se suma a la jornada regular de lunes a viernes. En función de lo anterior, las variables para evaluar esta dimensión son el número de horas trabajadas de lunes a viernes por sobre las 9 horas diarias permitidas en una jornada de trabajo regular (CEN1), y el número de horas trabajadas en sábado y domingo (CEN2, CEN3).

Todas las variables utilizadas fueron recodificadas con el objetivo de que valores más altos denotaran una mayor precariedad. Las variables que fueron recodificadas de manera más sustantiva que sólo el agrupamiento o reordenamiento de categorías, se encuentran marcadas con asteriscos y explicadas al pie de la Tabla 2. Sólo las variables de la dimensión control endógeno (CEN) son cuantitativas, mientras que el resto son ordinales.
Como se observa en la Tabla 2, en los ítems de las dimensiones temporalidad, ejercicio de derechos y control endógeno, la mayor parte de la muestra de trabajadores independientes se concentra en las categorías de menor precariedad, mientras que lo contrario ocurre en las dimensiones ingresos y control endógeno, especialmente en este último caso por el exceso de horas trabajadas el sábado. También en los ítems de la dimensión derechos se observa una alta precariedad, ya que la mayoría de los encuestados no está afiliado o no cotiza para jubilación ni para seguro de cesantía, mientras que lo contrario ocurre con la cobertura en el sistema de salud. 


Algunas variables ordinales presentan elevadas concentraciones en una categoría de respuesta, especialmente en las dimensiones temporalidad, derechos y control exógeno. Se acercan al 90% de los casos los trabajadores independientes que no estuvieron desempleados el año anterior (T1), los que tienen un trabajo de tipo permanente (T3), que no cotizan en el seguro de cesantía (D2), que sí están cubiertos por el sistema de salud (D3), que tienen más de un cliente (CEX1), que su trabajo no está normado por el cliente o proveedor (CEX3), y que no tienen relación de exclusividad con un cliente o proveedor (CEX4), sin embargo ninguna de estas variables presenta asimetrías que supongan un sesgo inaceptable en la estimación de las correlaciones entre variables, considerando que el AFI calcula para estos ítems ordinales correlaciones policóricas (Rdz-Navarro & Asún, 2016). En cuanto a la distribución de las variables continuas de la dimensión control endógeno, en la Figura 1 se aprecia que los tres ítems presentan una fuerte asimetría, con la mayor concentración de casos en la categoría cero horas y prevalencias relativamente bajas de las otras categorías, especialmente en CEN1 y CEN3. En efecto, la curtosis y la asimetría en estas tres variables es elevada, llegando a máximos en CEN1 de 10,6 y 3,1, respectivamente, superior a lo recomendado para la inclusión en el modelo (Barbeau et al., 2019). Por lo mismo, estas tres variables se incluyen transformadas en su raíz cuadrada, para acercar su distribución a la normal. 

El análisis factorial propuesto en la Tabla 1   converge y presenta la mayoría de los estadísticos de ajuste en niveles aceptables (Barbeau et al., 2019): χ2/gl = 1,919; RMSEA = 0,021; TLI = 0,964; CFI = 0,970; WRMR = 1,424. La única excepción es el valor del test de diferencia de chi cuadrado: χ2 (194 gl) = 372,19, p<0,001. Por otra parte, los ítems D3 y CEX2 presentan una carga factorial bajo el mínimo permitido, de 0,212 y 0,002, respectivamente, sin aportar información sustantiva a las dimensiones correspondientes (ver Anexo 1). El índice de modificación del modelo (MI) más elevado se presentó en relación al ítem T2, sugiriendo que la percepción de estabilidad en el empleo podía reflejar precariedad por ingresos (MI = 51,375 ), además de observarse que eliminar este ítem de la dimensión temporalidad aumenta la fiabilidad del factor. 

En función de lo anterior, se eliminaron los ítems T2, D3 y CEX2 del modelo, obteniéndose un modelo final (Figura 2) que presenta estadísticos de ajuste ligeramente mejores a los obtenidos en el modelo inicial: χ2 (137 gl) = 230,584, p<0,001, χ2/gl = 1,683; RMSEA = 0,018; TLI = 0,981; CFI = 0,985; WRMR = 1,150. Todas las variables incluidas en el modelo tienen una carga factorial superior a 0,4 y no hay índices de modificación elevados que sugieran nuevas modificaciones.

La fiabilidad de los factores estimada a partir del alfa ordinal para variables categóricas (Elosua & Zumbo, 2008) fluctúa entre 0,436 de la dimensión derechos y 0,950 de la dimensión ejercicio de derechos. En las dimensiones específicas propuestas para los trabajadores independientes, la fiabilidad es de 0,510 para el control exógeno y 0,670 para el control endógeno, medida en este caso a través del alfa de Cronbach. La dimensión control exógeno es la que, en promedio, explica una menor proporción de la varianza de los ítems que la componen, con un 8,5%, y la dimensión ejercicio de derechos la que más, con un 62,9%. La dimensión control endógeno explica en promedio el 32,0% de la varianza de sus ítems.

Las dimensiones propuestas suelen presentar relaciones intensas entre sí, destacando especialmente la relación entre ingresos y derechos (0,661), control exógeno con temporalidad (0,562), control endógeno con ejercicio de derechos (0,383), y las relaciones negativas entre control exógeno y control endógeno (-0,438) y control exógeno y derechos (-0,332).
